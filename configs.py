...
class Config(object):
    ...
    FROM_CHANNEL = int(os.environ.get("FROM_CHANNEL","-1001843409269"))
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL","-1001585205141"))
    ...
    CHANNEL = os.environ.get("CHANNEL","@seaofallmovies")
    START_FROM = int(os.environ.get("START_FROM","1000"))
